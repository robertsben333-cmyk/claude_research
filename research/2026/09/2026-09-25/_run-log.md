...
- Logged at 2026-09-25 19:13 UTC
- 19:13 UTC (15:13 ET), published before the 16:00 ET close. Drop date 2026-09-25, window to close 2026-09-28 (weekend). 15 of 15 hunted, 15 rankable, none shed. Above floor: IPEX -5.00 (de-SPAC closing-day supply unlock), DBGI -3.50 (open ATM, going concern); both leg 2, supply, no repricing finding. First leg-1 finding in three days: BYND +1.50 with a dated mechanism_in_window (end of the 09-23..25 VWAP exchange-pricing window), below the floor. Health Care 7/15 (47%). impact_sum vs priced_lean rho +0.06. Sum half-spread 13.24 pts vs prediction sd 1.55. Resolve (09-22+09-23 pooled, d1, n=30): impact_sum rho -0.167 p0.38; neg_atr14 -0.148; neg_ret_d -0.021; lean_vs_free_control_rho 0.107; more_to_come_pct -0.223 d1 / -0.328 open (wrong sign, n.s.). No run has beaten a free control. RESOLVER CAVEAT: IPEX trades as GOW from 2026-09-28; check the row resolves. TRT reported FY2026 results on 2026-09-24 (8-K + 10-K), unlike its 09-17 cadence prior. Session capped at 8 concurrent subagents; 7 hunters queued and started 2-5 min late. No orders; no execution step found.
