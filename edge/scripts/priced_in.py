...
it is free.
    ...
    python3 edge/scripts/priced_in.py --ticker SAIC --date 2026-08-31 --session bmo
    python3 edge/scripts/priced_in.py --tickers SAIC,SY,LX --date 2026-08-31 -o baselines/
"""
import argparse
