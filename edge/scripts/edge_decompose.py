...
p-values permute the realised moves within each day.
    ...
    python3 edge/scripts/edge_decompose.py --pool 'research/2026/*/*/edge'

Findings as of 43 resolved names live in edge/EDGE_ANALYSIS.md.
"""
import argparse
import glob
...
def main():
    ...
    ap.add_argument("--out", default="edge/analysis/edge-decompose.json")
    a = ap.parse_args()
    ...
    Path("edge/analysis/edge-rows.json").write_text(json.dumps(days, indent=1) + "\n")
