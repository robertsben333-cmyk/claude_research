#!/usr/bin/env python3
"""Compatibility shim. The real script is `researcher_us/scripts/alpaca_trade.py`.
...
TARGET = Path(__file__).resolve().parent.parent / "researcher_us" / "scripts" / "alpaca_trade.py"
