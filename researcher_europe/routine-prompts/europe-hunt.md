...
> - Each hunter runs its **English pass first**, freezes it as `pre_local`, then runs the local pass and revises. The ordering is load-bearing; reversing it tests a different question.
