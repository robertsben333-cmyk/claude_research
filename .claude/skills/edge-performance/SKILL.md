...
position past its exit date, you report it — `edge/scripts/alpaca_trade.py` and a
...
`edge/EDGE_ANALYSIS.md` and in `CLAUDE.md`, in the same commit. Do not leave the
