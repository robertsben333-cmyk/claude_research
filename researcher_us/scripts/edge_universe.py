...
not be in the window and that is a fact about the day rather than a bug.
    ...
    python3 researcher_us/scripts/edge_universe.py --date 2026-08-31 --session bmo
    python3 researcher_us/scripts/edge_universe.py --date 2026-09-01 --session amc -o universe.json
"""
import argparse
import json
import re
