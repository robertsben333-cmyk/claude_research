...
the adversary directory afterwards and reports any finding that never got a verdict.
    ...
    python3 researcher_us/scripts/edge_brief.py --run <RUN>/edge              # write the briefs
    python3 researcher_us/scripts/edge_brief.py --run <RUN>/edge --check      # verify the join
"""
import argparse
import json
import sys
