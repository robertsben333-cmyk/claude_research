...
events did, and on the four thinnest days the count was zero.
    ...
    python3 researcher_us/scripts/edge_calendar.py
    python3 researcher_us/scripts/edge_calendar.py --days 7 --out researcher_us/analysis/edge-calendar.json
"""
import argparse
import json
import sys
...
def main():
    ...
    ap.add_argument("--out", default="researcher_us/analysis/edge-calendar.json")
    a = ap.parse_args()
