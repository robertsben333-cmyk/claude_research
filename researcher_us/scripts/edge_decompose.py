...
p-values permute the realised moves within each day.
    ...
    python3 researcher_us/scripts/edge_decompose.py --pool 'research/2026/*/*/edge'

Findings as of 43 resolved names live in researcher_us/EDGE_ANALYSIS.md.
"""
import argparse
import glob
...
def main():
    ...
    ap.add_argument("--out", default="researcher_us/analysis/edge-decompose.json")
    a = ap.parse_args()
    ...
    Path("researcher_us/analysis/edge-rows.json").write_text(json.dumps(days, indent=1) + "\n")
