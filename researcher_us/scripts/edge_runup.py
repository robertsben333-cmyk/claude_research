...
the control's own book beside every cut for exactly that reason.
    ...
    python3 researcher_us/scripts/edge_runup.py
    python3 researcher_us/scripts/edge_runup.py --floor 3.0 --exit close
"""
import argparse
import json
...
def main():
    ...
    ap.add_argument("--out", default="researcher_us/analysis/edge-runup.json")
    a = ap.parse_args()
    ...
    print("has beaten the hunt on every sample in researcher_us/EDGE_ANALYSIS.md.\n")
