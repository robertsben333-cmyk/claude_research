...
Three more numbers, added 2026-09-09 because without them a run cannot be judged:
  ...
  pre-lessons          the same hunters' sizes before they opened researcher_us/LESSONS.md,
...
one day is an anecdote.
    ...
    python3 researcher_us/scripts/edge_resolve.py --run research/2026/09/2026-09-01/edge
    python3 researcher_us/scripts/edge_resolve.py --pool research/2026/09/*/edge
"""
import argparse
import glob
import json
...
def stats_for(live, seed):
    ...
    # researcher_us/LESSONS.md: the same hunters' sizes before they read the file, ranked
    ...
    if len(norm) >= 3:
        ...
        # WHICH DENOMINATOR. The normalised figure pools two different anchors --
        # what the option market paid, and what this company usually does -- and
        # until 2026-09-10 nothing said in what proportion. Report the mix beside
        # the number so a reader can see how much of it is a straddle at all.
        out["implied_basis_mix"] = {
