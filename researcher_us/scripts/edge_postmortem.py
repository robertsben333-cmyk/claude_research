...
whether it forecasts the reaction or only the print.
    ...
    python3 researcher_us/scripts/edge_postmortem.py --run <RUN>/edge --template   # write the file to fill
    python3 researcher_us/scripts/edge_postmortem.py --run <RUN>/edge              # score it
...
sign split. When a pattern in those tables recurs, it belongs in researcher_us/LESSONS.md --
