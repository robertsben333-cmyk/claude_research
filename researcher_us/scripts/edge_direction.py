...
would count those events twice.
    ...
    python3 researcher_us/scripts/edge_direction.py
    python3 researcher_us/scripts/edge_direction.py --key escore
"""
import argparse
import json
import math
...
def main():
    ...
    ap.add_argument("--out", default="researcher_us/analysis/edge-direction.json")
    a = ap.parse_args()
