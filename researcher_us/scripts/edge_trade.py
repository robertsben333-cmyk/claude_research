...
Reads researcher_us/analysis/edge-rows.json (written by edge_decompose.py) and runs the day's ranking
...
says nothing:
  ...
  capacity        spot x 20-day average volume for every position taken. A return
    ...
    python3 researcher_us/scripts/edge_trade.py
    python3 researcher_us/scripts/edge_trade.py --cost 1.5 --min-dollar-vol 5e6
"""
import argparse
import json
import math
...
def main():
    ...
    ap.add_argument("--rows", default="researcher_us/analysis/edge-rows.json")
