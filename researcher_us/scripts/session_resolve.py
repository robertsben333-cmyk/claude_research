...
tomorrow prints a full session after the entry.
    ...
    python3 researcher_us/scripts/session_resolve.py --universe <RUN>/edge/universe.json
    python3 researcher_us/scripts/session_resolve.py --universe <RUN>/edge/universe.json --apply
"""
import argparse
import json
import re
