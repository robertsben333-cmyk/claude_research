...
```
edge/
  README_V2.md          Stage E V2: The Shadow News Grounding Engine & Calibration Matrix
...
python3 researcher_us/scripts/priced_in.py --tickers <T,...> --date <D> --session <s> \
...
```bash
python3 researcher_us/scripts/edge_resolve.py --pool          # realised moves vs the ranking
python3 researcher_us/scripts/edge_decompose.py               # writes analysis/edge-rows.json
python3 researcher_us/scripts/edge_direction.py               # can the sum call direction
python3 researcher_us/scripts/edge_trade.py                   # the ranking traded as a book
python3 researcher_us/scripts/edge_exit.py                    # when to sell
python3 researcher_us/scripts/edge_hunter_control.py          # how much of it is the double hunt
python3 researcher_us/scripts/edge_turnover_floor.py          # what capacity costs
python3 researcher_us/scripts/edge_entry_timing.py            # market vs the closing auction
python3 researcher_us/scripts/edge_postmortem.py --run <RUN>/edge --template   # then fill and re-run
python3 researcher_us/scripts/edge_postmortem.py --pool 'research/2026/*/*/edge'  # fact right vs reaction right
```
